...
class CreditCardV1Schema extends pip_services_commons_node_1.ObjectSchema {
    constructor() {
        super();
        this.withOptionalProperty('id', pip_services_commons_node_2.TypeCode.String);
        this.withRequiredProperty('customer_id', pip_services_commons_node_2.TypeCode.String);
        ...
        this.withRequiredProperty('number', pip_services_commons_node_2.TypeCode.String);
        this.withRequiredProperty('expire_month', pip_services_commons_node_2.TypeCode.Integer);
        this.withRequiredProperty('expire_year', pip_services_commons_node_2.TypeCode.Integer);
        this.withRequiredProperty('first_name', pip_services_commons_node_2.TypeCode.String);

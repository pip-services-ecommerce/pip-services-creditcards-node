...
export interface ICreditCardsController {
    ...
    getCreditCardById(correlationId: string, card_id: string, customer_id: string, callback: (err: any, card: CreditCardV1) => void): void;
    ...
    deleteCreditCardById(correlationId: string, card_id: string, customer_id: string, callback: (err: any, card: CreditCardV1) => void): void;
}

...
class CreditCardsCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetCreditCardsCommand() {
        return new pip_services3_commons_node_2.Command("get_credit_cards", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetCreditCardByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_credit_card_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('card_id', pip_services3_commons_node_6.TypeCode.String)
    ...
    makeCreateCreditCardCommand() {
        return new pip_services3_commons_node_2.Command("create_credit_card", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateCreditCardCommand() {
        return new pip_services3_commons_node_2.Command("update_credit_card", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('card', new CreditCardV1Schema_1.CreditCardV1Schema()), (correlationId, args, callback) => {
            let card = args.get("card");
    ...
    makeDeleteCreditCardByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_credit_card_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('card_id', pip_services3_commons_node_6.TypeCode.String)
            .withRequiredProperty('customer_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {

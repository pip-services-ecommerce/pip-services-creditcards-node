...
class CreditCardsServiceFactory extends pip_services3_components_node_1.Factory {
    constructor() {
        super();
...
CreditCardsServiceFactory.MongoDbPersistenceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-creditcards", "persistence", "mongodb", "*", "1.0");
